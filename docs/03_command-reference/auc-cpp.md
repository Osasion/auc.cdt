---
content_title: auc-cpp tool
---

To manually compile the source code, use `auc-cpp` and `auc-ld` as if it were __clang__ and __lld__. All the includes and options specific to AUC and CDT are baked in.

```
USAGE: auc-cpp [options] <input file> ...
