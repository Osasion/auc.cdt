...
* An AUC development environment, for details consult the [Get Started Guide](https://github.com/Osasion/eosio.cdt/tree/develop).
...
For a complete example of a smart contract that implements an action which returns a value see the [hello example smart contract](https://github.com/Osasion/eosio.cdt/blob/develop/examples/hello/src/hello.cpp#L16).
